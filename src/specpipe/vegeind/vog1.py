# -*- coding: utf-8 -*-
"""
SpecPipe - Vegetation Indices - VOG1 (Vogelmann Red Edge Index)
...
def vog1(
    ...
    """
    Compute VOG1 (Vogelmann Red Edge Index) of 2D arraylike of 1D spectra data series.
    ...
    if axis == 0:
        df_vi = pd.DataFrame(vi_values.T, columns=['VOG1'])
    else:
        df_vi = pd.DataFrame(vi_values, index=['VOG1'])
